load_20132021_cpsfiles <- function(base_folder, race_folders) {
  final_data <- data.frame()  # Initialize empty dataframe
  ...
  for (folder in names(race_folders)) {
    ...
    # Get list of valid .xls/.xlsx files, excluding Excel lock files
    ...
    for (file_path in file_list) {
      ...
      educ_mapping <- c("col_3" = 0, "col_4" = 1, "col_5" = 1, "col_6" = 1, "col_7" = 1, "col_8" = 1,
                        "col_9" = 1, "col_10" = 2, "col_11" = 3, "col_12" = 3, "col_13" = 3,
