...
makeAppended = function(full, empty_rank){
  ...
  app_rank = app_rank %>%
    mutate(
      ...
      tsurvrate = ifelse(tmortrate != 0 & !is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (100000 - tmortrate), 0),
      pmortrate = ifelse(!is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (pmort / tpop_rolling_5)*100000, 0),
      psurvrate = ifelse(pmortrate != 0 & !is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (100000 - pmortrate), 0),
      smortrate = ifelse(!is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (smort / tpop_rolling_5)*100000, 0),
      ssurvrate = ifelse(smortrate != 0 & !is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (100000 - smortrate), 0),
      lmortrate = ifelse(!is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (lmort / tpop_rolling_5)*100000, 0),
      lsurvrate = ifelse(lmortrate != 0 & !is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (100000 - lmortrate), 0),
      hmortrate = ifelse(!is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (hmort / tpop_rolling_5)*100000, 0),
      hsurvrate = ifelse(hmortrate != 0 & !is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (100000 - hmortrate), 0),
      cmortrate = ifelse(!is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (cmort / tpop_rolling_5)*100000, 0),
      csurvrate = ifelse(cmortrate != 0 & !is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (100000 - cmortrate), 0),
      lungcmortrate = ifelse(!is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (lungcmort / tpop_rolling_5)*100000, 0),
      lungcsurvrate = ifelse(lungcmortrate != 0 & !is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (100000 - lungcmortrate), 0),
      cdmortrate = ifelse(!is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (cdmort / tpop_rolling_5)*100000, 0),
      cdsurvrate = ifelse(cdmortrate != 0 & !is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (100000 - cdmortrate), 0),
      clmortrate = ifelse(!is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (clmort / tpop_rolling_5)*100000, 0),
      clsurvrate = ifelse(clmortrate != 0 & !is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (100000 - clmortrate), 0),
      dmortrate = ifelse(!is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (dmort / tpop_rolling_5)*100000, 0),
      dsurvrate = ifelse(cdmortrate != 0 & !is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (100000 - dmortrate), 0),
      rmortrate = ifelse(!is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (rmort / tpop_rolling_5)*100000, 0),
      rsurvrate = ifelse(rmortrate != 0 & !is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (100000 - rmortrate), 0),
      amortrate = ifelse(!is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (amort / tpop_rolling_5)*100000, 0),
      asurvrate = ifelse(amortrate != 0 & !is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (100000 - amortrate), 0),
      omortrate = ifelse(!is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (omort / tpop_rolling_5)*100000, 0),
      osurvrate = ifelse(omortrate != 0 & !is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (100000 - omortrate), 0),
      ormortrate = ifelse(!is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (ormort / tpop_rolling_5)*100000, 0),
      orsurvrate = ifelse(ormortrate != 0 & !is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (100000 - ormortrate), 0),
      ovmortrate = ifelse(!is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (ovmort / tpop_rolling_5)*100000, 0),
      ovsurvrate = ifelse(ovmortrate != 0 & !is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (100000 - ovmortrate), 0),
      icd10amortrate = ifelse(!is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (icd10amort / tpop_rolling_5)*100000, 0),
      icd10asurvrate = ifelse(icd10amortrate != 0 & !is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (100000 - icd10amortrate), 0),
      icd10bmortrate = ifelse(!is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (icd10bmort / tpop_rolling_5)*100000, 0),
      icd10bsurvrate = ifelse(icd10bmortrate != 0 & !is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (100000 - icd10bmortrate), 0),
      icd10dmortrate = ifelse(!is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (icd10dmort / tpop_rolling_5)*100000, 0),
      icd10dsurvrate = ifelse(icd10dmortrate != 0 & !is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (100000 - icd10dmortrate), 0),
      icd10emortrate = ifelse(!is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (icd10emort / tpop_rolling_5)*100000, 0),
      icd10esurvrate = ifelse(icd10emortrate != 0 & !is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (100000 - icd10emortrate), 0),
      icd10fmortrate = ifelse(!is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (icd10fmort / tpop_rolling_5)*100000, 0),
      icd10fsurvrate = ifelse(icd10fmortrate != 0 & !is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (100000 - icd10fmortrate), 0),
      icd10gmortrate = ifelse(!is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (icd10gmort / tpop_rolling_5)*100000, 0),
      icd10gsurvrate = ifelse(icd10gmortrate != 0 & !is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (100000 - icd10gmortrate), 0),
      icd10hmortrate = ifelse(!is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (icd10hmort / tpop_rolling_5)*100000, 0),
      icd10hsurvrate = ifelse(icd10hmortrate != 0 & !is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (100000 - icd10hmortrate), 0),
      icd10imortrate = ifelse(!is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (icd10imort / tpop_rolling_5)*100000, 0),
      icd10isurvrate = ifelse(icd10imortrate != 0 & !is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (100000 - icd10imortrate), 0),
      icd10jmortrate = ifelse(!is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (icd10jmort / tpop_rolling_5)*100000, 0),
      icd10jsurvrate = ifelse(icd10jmortrate != 0 & !is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (100000 - icd10jmortrate), 0),
      icd10kmortrate = ifelse(!is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (icd10kmort / tpop_rolling_5)*100000, 0),
      icd10ksurvrate = ifelse(icd10kmortrate != 0 & !is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (100000 - icd10kmortrate), 0),
      icd10lmortrate = ifelse(!is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (icd10lmort / tpop_rolling_5)*100000, 0),
      icd10lsurvrate = ifelse(icd10lmortrate != 0 & !is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (100000 - icd10lmortrate), 0),
      icd10mmortrate = ifelse(!is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (icd10mmort / tpop_rolling_5)*100000, 0),
      icd10msurvrate = ifelse(icd10mmortrate != 0 & !is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (100000 - icd10mmortrate), 0),
      icd10nmortrate = ifelse(!is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (icd10nmort / tpop_rolling_5)*100000, 0),
      icd10nsurvrate = ifelse(icd10nmortrate != 0 & !is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (100000 - icd10nmortrate), 0),
      icd10omortrate = ifelse(!is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (icd10omort / tpop_rolling_5)*100000, 0),
      icd10osurvrate = ifelse(icd10omortrate != 0 & !is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (100000 - icd10omortrate), 0),
      icd10pmortrate = ifelse(!is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (icd10pmort / tpop_rolling_5)*100000, 0),
      icd10psurvrate = ifelse(icd10pmortrate != 0 & !is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (100000 - icd10pmortrate), 0),
      icd10qmortrate = ifelse(!is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (icd10qmort / tpop_rolling_5)*100000, 0),
      icd10qsurvrate = ifelse(icd10qmortrate != 0 & !is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (100000 - icd10qmortrate), 0),
      icd10rmortrate = ifelse(!is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (icd10rmort / tpop_rolling_5)*100000, 0),
      icd10rsurvrate = ifelse(icd10rmortrate != 0 & !is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (100000 - icd10rmortrate), 0),
      vmortrate = ifelse(!is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (vmort / tpop_rolling_5)*100000, 0),
      vsurvrate = ifelse(vmortrate != 0 & !is.na(tpop_rolling_5) & (tpop_rolling_5 != 0), (100000 - vmortrate), 0)
    )
...
makeMortMeans = function(app_rank, empty_mort){
  mort_means = empty_mort
  app_rank = app_rank %>% 
    mutate(
...
#use_full_data = educationRank(use_full_data) #This one is not needed anymore


#####################################################################3

#Expand the appended mort rank set with 2019-2021
added_columns = c("year", "edclass", "age_gp", "race", "sex")
other_columns = setdiff(names(appended_rank_mort), added_columns)
...
write.csv(new_appended, "C:/Users/michi/OneDrive/Documenten/Eur Jaar 3/Blok 4/Major/Data US/appended_rank_mort_homemade.csv")
...
added_columns = c("year", "age", "race", "sex")
other_columns = setdiff(names(empty_mort), added_columns)
create_years = expand.grid(
  year = 2019:2021,
  age = unique(appended_rank_mort$age_gp),
  race = unique(appended_rank_mort$race),
  sex = unique(appended_rank_mort$sex)
)
# Add NA columns for all other variables
...
write.csv(new_mortm, "C:/Users/michi/OneDrive/Documenten/Eur Jaar 3/Blok 4/Major/Data US/mort_means_homemade.csv")
