...
/* Adjust race to 1,2,3 or 5 */
/* This code produces the bounds for the given age-race combination */
forvalues age = 25(5)65 {
	shell matlab -nodisplay -r "calc_all_mort_bounds_parallel(`age', 1 , '$mcode/mort-solver', '$mdata/int/bounds'); exit;"
}
