...
notes taxp: Topcode: 10000 annually (2005-2017), 22500 (2021)
notes taxp: Additional topcoding using state-level thresholds in 2021 
...
if (2005<=`year' & `year'<=2012) | (2016<=`year' & `year'<=2021) {
gen byte dsl=. 
}
