...
do "cepr_acs_demog_anc18.do" /*consistent for 2021*/
...
replace yoep=. if 2021<yoep
}
lab var yoep "Year of Entry"
notes yoep: ACS: YOEP
notes yoep: Bottom-coded at 1919 (2005-2011), 1921 (2012-2016), 1925 (2017), 1929 (2021)
...
2017 "2017" ///
2021 "2021"
lab var yoep18 "Year of Entry (2021 categories)"
...
if 2008<=`year' & `year'<=2021 {
replace citwp=. if citwp<1925
replace citwp=. if 2021<citwp
}
lab var citwp "Year of naturalization"
notes citwp: ACS: CITWP
notes citwp: Bottom-coded at 1925 (2008-2011), 1928 (2012-2016), 1939 (2017-2021)
...
2017 "2017" ///
2021 "2021"
lab var citwp17 "Year of naturalization (2017-2021 categories)"
...
lab def waob18	1 "US" ///
		...
		7 "Northern America" ///
		8 "Oceania and at Sea"
lab var waob18 "World area of birth (2021 categories)"
lab val waob18 waob18
notes waob18: ACS: WAOB
notes waob18: ACS categorizes American Samoa as Oceania and at Sea in 2021, /* 
...
do "cepr_acs_demog_POB17.do" /* Consistent for 2017-2021 */
